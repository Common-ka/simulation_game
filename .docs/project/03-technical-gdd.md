...
|---|---|---|---|---|
| **Мелкий пакет** | 1 | 0% | **1.0** | Одна центральная рулетка |
| **Малая коробка** | 3 | 2% | **2.94** | Сетка 3x1 |
| **Средний ящик** | 5 | 5% | **4.75** | Сетка 5x1 |
| **Большой баул** | 8 | 8% | **7.36** | Сетка 4x2 |
| **Складская паллета** | 10 | 10% | **9.0** | Сетка 5x2 |
