...
> Коэффициент `0.?` (вместо линейного роста) обеспечивает убывающую доходность: каждый следующий Престиж даёт меньше PP на единицу заработка, чем предыдущий.
...
### 3.1 Типы лотов и механика рулеток

Внутри каждой категории игроку доступно 5 типов лотов (контейнеров), отличающихся количеством одновременно прокручивающихся рулеток и прогрессивной скидкой. Каждая рулетка в лоте делает независимый расчет шансов на предмет и стикер.

| Название лота | Кол-во рулеток | Скидка | Цена (в базовых коробках) | Тип UI |
|---|---|---|---|---|
| **Почтовая коробка** | 1 | 0% | **1.0** | Рулетки будут вертикальные |
| **Сумка курьера** | 3 | 2% | **2.94** | Рулетки будут вертикальные |
| **Забытый дипломат** | 5 | 5% | **4.75** | Рулетки будут вертикальные |
| **Защищенный кейс** | 8 | 8% | **7.36** | Рулетки будут вертикальные |
| **Складской ящик** | 10 | 10% | **9.0** | Рулетки будут вертикальные |

**Формула стоимости:**
`LotPrice = BaseBoxPrice * Quantity * (1 - Discount)`

> **Преимущество:** Открытие больших лотов не только экономит время за счет параллельной анимации всех рулеток, но и стратегически выгоднее по стоимости за единицу лута.

### 3.2 Механика выпадения стикеров
...
### 3.4 Таблица Звёздной пыли (DustBurnTable)
...
### 3.6 Математическое ожидание закрытия сета
...
### 3.8 X-Ray (Рентген коробки)

**Суть:** до открытия рулетки игрок платит (rewarded или Токены) и видит содержимое. Если нравится — открывает с гарантией. Если нет — бесплатный Refresh, но уже вслепую.
